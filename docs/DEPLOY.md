...
`daytrade snap`（8:30・8:45・8:55・8:57・8:59:00／9:00:05・9:02・9:05・9:11／15:00・15:19）は板・気配を記録するだけで
...
**既定（170 + 10）のままでよいのは、TERM と KILL が寄る前の寄成（`DT_PREOPEN_AT`、8:59:48）より手前に着く行だけ（2026-09-25 から寄る前の全銘柄の板は `open` の中で撮る）。** 8:30・8:45・8:55 の `snap` は
